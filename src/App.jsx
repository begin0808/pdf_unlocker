  ...
  return (
    <div className="min-h-screen bg-sunny-gradient bg-grid relative text-slate-800 p-2 md:p-4 overflow-hidden" style={{ fontFamily: '"Microsoft JhengHei", "Inter", sans-serif' }}>
      ...
      <div className="max-w-4xl mx-auto relative z-10 pt-4">
        ...
        {files.length > 0 && (
          <div className="mt-4 animate-in fade-in slide-in-from-bottom-4 duration-500">
            <div className="sunny-card shadow-lg rounded-xl overflow-hidden divide-y divide-amber-200/60 border border-yellow-300 bg-amber-50/90">
              ...
              {/* 底部整體操作 */}
              <div className="bg-amber-200/60 backdrop-blur-sm p-4 sm:p-5 flex flex-col sm:flex-row justify-between items-center gap-4 border-t border-amber-300 shadow-inner">
        ...
        {/* 最高隱私驗證說明 (Q&A) */}
        <div className="mt-8 mb-2 bg-orange-100 shadow-md rounded-xl p-5 sm:p-6 border-2 border-orange-300 animate-in fade-in duration-700">
          ...
          <p className="text-[15px] sm:text-[16px] text-slate-600 leading-relaxed font-medium">
            本工具採用先進的 WebAssembly 邊緣運算技術。您可以<strong className="text-orange-600 font-bold mx-0.5">「在載入網頁後，直接關閉您的 Wi-Fi 或網路連線」</strong>再拖曳檔案進行解鎖。您會發現即使在無網路的離線狀態下，解碼速度與結果皆完全不受影響。這正是您的文件從頭到尾都不曾離開過您電腦的最佳鐵證。
          </p>
        </div>
